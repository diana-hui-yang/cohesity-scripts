...
adump_directory=`grep -i adump $dbpfile | awk -F "'" '{print $2}' | awk -F "%" '{print $1}'`
...
# start the duplicate database in nomount mode it it has not been started
