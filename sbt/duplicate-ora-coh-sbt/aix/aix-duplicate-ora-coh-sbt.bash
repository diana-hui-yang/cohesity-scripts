...
# 05/05/21 Diana Yang   Add refresh option
#
#################################################################

function show_usage {
echo "usage: aix-duplicate-ora-coh-sbt.bash -r <Target connection> -e <Catalog connection> -b <backup host> -a <target host> -d <Source Oracle_DB_Name> -t <Target Oracle instance name> -y <Cohesity-cluster> -l <file contain duplicate settting> -i <file contain setting to new spfile> -j <vip file> -v <view> -s <sbt file name> -p <number of channels> -o <ORACLE_HOME> -c <source PDB> -f <yes/no> -w <yes/no>" 
echo " "
