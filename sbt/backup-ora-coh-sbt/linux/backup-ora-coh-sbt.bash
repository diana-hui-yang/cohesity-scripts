...
if [[ $archretday = [Nn]* ]]; then
   echo "backup archivelog all filesperset 8 format './$host/$dbname/%d_%T_%U.blf' not backed up $archcopynum times;" >> $rmanfilea
elif [[ $archretday -eq 0 ]]; then
   echo "backup archivelog all filesperset 8 format './$host/$dbname/%d_%T_%U.blf' not backed up $archcopynum times delete input;" >> $rmanfilea
else
   echo "backup archivelog all filesperset 8 format './$host/$dbname/%d_%T_%U.blf' not backed up $archcopynum times archivelog until time 'sysdate-$archretday' delete input;" >> $rmanfilea
fi
...
if [[ $archretday = [Nn]* ]]; then
   echo "backup archivelog all filesperset 8 format './$host/$dbname/%d_%T_%U.blf' not backed up $archcopynum times;" >> $rmanfilear
elif [[ $archretday -eq 0 ]]; then
   echo "backup archivelog all filesperset 8 format './$host/$dbname/%d_%T_%U.blf' not backed up $archcopynum times delete input;" >> $rmanfilear
else
   echo "backup archivelog all filesperset 8 format './$host/$dbname/%d_%T_%U.blf' not backed up $archcopynum times archivelog until time 'sysdate-$archretday' delete input;" >> $rmanfilear 
fi
