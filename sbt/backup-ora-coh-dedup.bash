...
#           echo "return is $return"
	      ...
	      if [[ $i -eq 1 ]]; then
	         echo "CONFIGURE CHANNEL DEVICE TYPE 'SBT_TAPE' PARMS 'SBT_LIBRARY=$sbthome/libsbt_6_and_7_linux-x86_64.so,SBT_PARMS=(mount_path=$ip:/$view,vips=$ip)';" >> $rmanfiled_b
#	         echo "Delete obsolete;" >> $rmanfiled_b
	         ...
	         echo "allocate CHANNEL c$j TYPE 'SBT_TAPE' PARMS 'SBT_LIBRARY=$sbthome/libsbt_6_and_7_linux-x86_64.so,SBT_PARMS=(mount_path=$ip:/$view,vips=$ip)' format '%d__%T_%U.bdf';" >> $rmanfiled_b
