...
-s $dedup_code_directory -f $force
#/home/oracle1/scripts/dedup/rman/restore-ora-coh-dedup.bash -i $oracle_instance -l $restore_controlfile -j $vip_file -v $view -s $dedup_code_direct
ory -f $force
