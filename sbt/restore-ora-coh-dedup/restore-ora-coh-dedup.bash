...
echo " -f : yes means force. It will testore Oracle database. Without it, it will just run RMAN validate (Optional)"
...
while getopts ":r:h:i:d:t:l:j:v:s:p:o:f:c:w:" opt; do
  case $opt in
    r ) rmanlogin=$OPTARG;;
    h ) host=$OPTARG;;
    i ) oraclesid=$OPTARG;;
