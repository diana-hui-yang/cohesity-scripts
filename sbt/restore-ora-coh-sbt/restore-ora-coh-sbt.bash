...
# 08/16/2020 Diana Yang   All set newname during restore
#
#################################################################

function show_usage {
echo "usage: restore-ora-coh-sbt.bash -r <RMAN login> -h <backup host> -i <Oracle instance name> -d <Oracle_DB_Name> -c <file contain duplicate settting> -t <point-in-time> -l <yes/no> -j <vip file> -v <view> -s <sbt file name> -p <number of channels> -o <ORACLE_HOME> -f <yes/no> -w <yes/no>"
...
echo " -c : File contains duplicate setting, example: set newname for database to '/oradata/restore/orcl/%b'; "
...
while getopts ":r:h:i:d:c:t:l:j:v:s:p:o:f:w:" opt; do
  case $opt in
    r ) rmanlogin=$OPTARG;;
    h ) host=$OPTARG;;
    i ) oraclesid=$OPTARG;;
