...
function show_usage {
echo "usage: delete-ora-expired.bash -h <host> -a <yes/no> -o <Oracle_DB_Name> -d <Backup Files Directory> -r <specified day> -f <yes/no>" 
...
function listfiles {
   ...
   if [[ $allfile = "yes" ]]; then
      ...
      find $backupdir -type f -mtime +$ret |  grep -v "snapshot" > $filelist
      ...
      find $backupdir -type f -mtime +$ret -name ${dbname}_* |  grep -v "snapshot" > $filelist
...
function deletefiles {
   ...
   find $backkupdir -type d -empty -delete
}
