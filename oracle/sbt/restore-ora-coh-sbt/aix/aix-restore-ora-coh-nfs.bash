...
# 12/08/21 Diana Yang   Change awk to /opt/freeware/bin/gawk, date to /opt/freeware/bin/date
...
while IFS= read -r line; do
   ...
   bitime=`echo $line | /opt/freeware/bin/gawk '{print $6 " " $7 " " $8}'`
   bfile=`echo $line | /opt/freeware/bin/gawk '{print $NF}'`
