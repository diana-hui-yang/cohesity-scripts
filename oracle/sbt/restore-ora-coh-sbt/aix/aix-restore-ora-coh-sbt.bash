...
function show_usage {
echo "usage: aix-restore-ora-coh-sbt.bash -h <backup host> -c <Catalog connection> -i <Oracle instance name> -d <Oracle_DB_Name> -y <Cohesity-cluster> -t <point-in-time> -l <yes/no> -j <vip file> -v <view> -s <sbt file name> -p <number of channels> -o <ORACLE_HOME> -f <yes/no> -w <yes/no> -g <yes/no> -k <cert path> -x <yes/no>"
echo " "
...
if [[ ${fra:0:1} != "+" ]]; then
   ...
   dirsize=`du -sk $fra | /opt/freeware/bin/gawk '{print $1}'`
