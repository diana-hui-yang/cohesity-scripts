...
- ./restore-ora-coh-sbt.ksh -i orcl -y cohesity -v orasbt1
...
- ./restore-ora-coh-sbt.ksh -i orcl -y cohesity -v orasbt1 -s /u01/app/coheisty -f yes
### Restore controlfile, then database "orcl" on the original Oracle server "orawest".  The database will be over-written.
- ./restore-ora-coh-sbt.ksh  -i orcl -t "2020-08-02 12:00:00" -l yes -y cohesity -v orasbt1 -f yes
...
- ./restore-ora-coh-sbt.ksh -h orawest -i orcl -t "2020-08-02 12:00:00" -l yes -y cohesity -v orasbt1 -f yes
