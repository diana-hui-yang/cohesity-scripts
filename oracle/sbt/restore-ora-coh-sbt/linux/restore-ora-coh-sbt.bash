...
# 08/06/20 Diana Yang   Rename this file from restore-ora-coh-dedup.bash to restore-ora-coh-sbt.bash/opt/freeware/bin/curl -O https://raw.githubusercontent.com/diana-hui-yang/rman-cohesity/master/oracle/sbt/restore-ora-coh-sbt/aix/aix-restore-ora-coh-sbt.bash
