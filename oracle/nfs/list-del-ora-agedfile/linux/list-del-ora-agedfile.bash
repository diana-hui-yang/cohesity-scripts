#!/bin/bash
#
# Name:         list-del-ora-agedfile.bash
#
...
function show_usage {
echo "usage: list-del-ora-agedfile.bash -h <host> -a <yes/no> -s <matching pattern> -d <Backup Files Directory> -r <specified day> -f <yes/no>" 
...
echo      find $backupdir -type f -mtime +$ret -name *${match}* |  grep -v "snapshot"
      find $backupdir -type f -mtime +$ret -name *${match}* |  grep -v "snapshot" > $filelist
