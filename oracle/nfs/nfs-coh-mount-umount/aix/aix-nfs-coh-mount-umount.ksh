...
#             if echo sudo mount -o rw,bg,hard,intr,rsize=524288,wsize=524288,vers=3,proto=tcp,sec=sys,llock,noac $ip:/${view} ${mount}$j; then      
