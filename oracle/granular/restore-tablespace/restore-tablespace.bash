...
#
# Function:     This script restore Oracle tablespaces from Oracle backup to the current point. It is used  
#				in the situation that the tablespace is corrupted. It can't be used to restore point-in-time 
#				tablespace or dropped tablespace. For that use case, please use import-tablespace script.
