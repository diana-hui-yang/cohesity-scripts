...
function show_usage {
echo "usage: export-ora-coh-nfs-mount.bash -s <Sqlplus connection> -h <host> -o <Oracle_sid> -r <remote sqlplus connection> -y <Cohesity-cluster> -v <view> -m <mount-prefix> -n <number of mounts> -d <number of export directories> -p <number of parallels> -e <retention> -z <file size> -x <ORACLE_HOME> -c <export options> -a <yes/no> -w <yes/no>"
echo " "
...
while getopts ":s:r:h:o:d:y:v:m:n:p:a:e:z:x:c:w:" opt; do
  case $opt in
    s ) sqlplusc=$OPTARG;;
    r ) rsqlplusc=$OPTARG;;
    h ) host=$OPTARG;;
