...
if ! [[ "$retday" =~ ^[0-9]+$ ]]; then
 ...
 #   filenum=`wc -l ${filelist} | /opt/freeware/bin/gawk '{print $1}'`
  ...
  if [[ -d "${mount}1/$orighost/$origdbname" ]]; then
    ...
    /opt/freeware/bin/find ${mount}1/$orighost/$origdbname/* -type d -mtime +$retnewday -prune -exec rm -rv {} \; >> $runlog
 ...
 #   filenum=`wc -l ${filelist} | awk '{print $1}'`
    ...
    /opt/freeware/bin/find ${mount}1/$orighost/$origdbname -depth -type d -empty -exec /bin/rmdir -v {} \; >> $runlog
