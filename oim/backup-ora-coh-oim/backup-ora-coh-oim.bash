...
function show_usage {
echo "usage: backup-ora-coh-oim.bash -r <RMAN login> -h <host> -o <Oracle_DB_Name> -t <backup type> -a <archive only> -m <mount-prefix> -n <number of mounts> -p <number of channels> -e <retention> -l <archive log keep days> -m <ORACLE_HOME> -w <yes/no>" 
