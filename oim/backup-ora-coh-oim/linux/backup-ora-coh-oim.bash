 ...
 #   filenum=`wc -l ${filelist} | awk '{print $1}'`
  ...
  if [[ -d "${mount}1/$orighost/$origdbname" ]]; then
    ...
    if [[ -d ${mount}1/$orighost/$origdbname/datafile ]]; then
       find ${mount}1/$orighost/$origdbname/datafile/* -type f -mtime +1 | grep -v D-${dbname^^} >> ${origfilelist}
    fi
    ...
    find ${mount}1/$orighost/$origdbname/* -type d -mtime +$retnewday -prune -exec rm -rv {} \; >> $runlog
