...
# 08/26/2020 Diana Yang   Add more contrains in RAC environment.
# 10/15/2020 Diana Yang   Add Deletion of the expired backup using unix command
# 10/23/2020 Diana Yang   Modify it to work in Solaris environment
#
#################################################################

function show_usage {
echo "usage: backup-ora-coh-oim.bash -r <RMAN login> -h <host> -o <Oracle_DB_Name> -t <backup type> -a <archive only> -m <mount-prefix> -n <number of mounts> -p <number of channels> -e <retention> -l <archive log keep days> -b <ORACLE_HOME> -w <yes/no>" 
echo " "
