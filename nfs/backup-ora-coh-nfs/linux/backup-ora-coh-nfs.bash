...
echo " -f : RMAN compression (Optional, yes means RMAN compression. no means no RMAN compression. default is no)"
echo " -t : RMAN TAG"
...
while getopts ":r:c:h:d:o:a:i:m:n:p:e:l:b:z:f:x:t:w:" opt; do
  case $opt in
    r ) targetc=$OPTARG;;
    c ) catalogc=$OPTARG;;
    h ) host=$OPTARG;;
