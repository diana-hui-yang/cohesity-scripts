...
while getopts ":r:c:h:d:o:a:i:m:n:p:e:l:b:z:m:t:w:" opt; do
  case $opt in
    r ) targetc=$OPTARG;;
    c ) catalogc=$OPTARG;;
    h ) host=$OPTARG;;
