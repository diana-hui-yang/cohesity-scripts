...
function show_usage {
echo "usage: backup-ora-coh-nfs.bash -r <RMAN login> -h <host> -o <Oracle_sid> -a <archive only> -i <incremental level> -m <mount-prefix> -n <number of mounts> -p <number of channels> -e <retention> -l <archive log keep days> -z <section size> -b <ORACLE_HOME> -w <yes/no>"
echo " "
