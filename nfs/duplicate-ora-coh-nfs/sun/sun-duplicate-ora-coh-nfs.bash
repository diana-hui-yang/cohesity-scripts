...
# 10/25/2021 Diana Yang   Use gfind, ggawk, and "hostname"
...
function show_usage {
echo "usage: duplicate-ora-coh-nfs.bash -r <Target connection> -e <Catalog connection> -b <Source host> -d <Source Oracle database> -a <Target host> -t <Target Oracle_DB_Name> -l <file contain duplicate settting> -m <mount-prefix> -n <number of mounts> -p <number of channels> -o <ORACLE_HOME> -c <source PDB> -f <yes/no> -w <yes/no>" 
echo " "
