...
function show_usage {
echo "usage: duplicate-ora-coh-nfs.bash -r <Target connection> -e <Catalog connection> -b <backup host> -a <target host> -d <Source Oracle_DB_Name> -t <Target Oracle database> -l <file contain duplicate settting> -m <mount-prefix> -n <number of mounts> -p <number of channels> -o <ORACLE_HOME> -c <source PDB> -f <yes/no> -w <yes/no>" 
echo " "
