...
function show_usage {
echo "usage: duplicate-ora-coh-nfs.bash -r <Source ORACLE connection> -e <Catalog ORACLE connection> -b <Source host> -t <Source Oracle database> -a <Target host> -d <Target Oracle_DB_Name> -l <file contain duplicate settting> -m <mount-prefix> -n <number of mounts> -p <number of channels> -o <ORACLE_HOME> -c <source PDB> -f <yes/no> -w <yes/no>" 
echo " "
