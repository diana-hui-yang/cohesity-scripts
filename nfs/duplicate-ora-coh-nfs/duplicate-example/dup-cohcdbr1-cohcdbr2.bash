...
/home/oracle1/scripts/nfs/rman/duplicate-ora-coh-nfs.bash -i ${target_oraclesid} -r ${targetconnect} -h ${source_host} -d ${source_db} -t "2022-04-01 12:30:00" -m /coh/oraoim -n 4
