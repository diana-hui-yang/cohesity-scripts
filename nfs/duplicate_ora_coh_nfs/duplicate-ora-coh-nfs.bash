...
function show_usage {
echo "usage: duplicate-ora-coh-nfs.bash -r <RMAN login> -b <backup host> -a <target host> -s <Source Oracle_DB_Name> -t <Target Oracle database> -f <file contain duplicate settting> -i <file contain setting to new spfile> -m <mount-prefix> -n <number of mounts> -p <number of channels> -o <ORACLE_HOME> -c <pluggable database> -w <yes/no>" 
echo " "
...
echo " -f : File contains duplicate settting, example: set newname for database to '/oradata/restore/orcl/%b'; Provide full path"
