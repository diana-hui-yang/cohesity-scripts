...
# 10/12/21 Diana Yang   Use gfind, ggawk, and "hostname"
...
function show_usage {
echo "usage: restore-ora-coh-nfs.bash -h <backup host> -c <Catalog connection> -i <Oracle instance name> -d <Oracle_DB_Name> -b <file contain restore settting> -t <point-in-time> -l <yes/no> -m <mount-prefix> -n <number of mounts> -p <number of channels> -o <ORACLE_HOME> -f <yes/no> -w <yes/no>"
echo " "
