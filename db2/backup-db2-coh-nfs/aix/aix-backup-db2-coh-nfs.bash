...
function show_usage {
echo "usage: aix-backup-db2-coh-nfs.bash -d <database name> -t <full or incremental> -l <offline or online> -m <mount-prefix> -n <number of mounts> -p <number of sessions> -e <retention> -f <DB2 profile> -w <yes/no>"
echo " "
