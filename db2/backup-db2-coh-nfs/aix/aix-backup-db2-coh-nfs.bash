#!/bin/bash
#
# Name:         aix-backup-db2-coh-nfs.bash
#
...
# 09/20/22 Diana Yang   Change "awk" to "/opt/freeware/bin/gawk", change "find" to "/opt/freeware/bin/find",
# 09/20/22 Diana Yang	change "/bin/rm" to "/opt/freeware/bin/rm"
#
#################################################################

function show_usage {
echo "usage: aix-backup-db2-coh-nfs.bash -d <database name> -t <full or incremental> -l <offline or online> -m <mount-prefix> -n <number of mounts> -p <number of sessions> -e <retention> -w <yes/no>"
echo " "
...
while getopts ":d:t:l:m:n:e:p:w:" opt; do
  case $opt in
    l ) dbstage=$OPTARG;;
    d ) dbname=$OPTARG;;
    t ) backuptype=$OPTARG;;
