...
db2db_cmd=$DIR/log/$dbname/$dbname.db.$DATE_SUFFIX.ksh
...
echo "
db2 list history backup all for $dbname > ${mount}1/backup/${dbname}/$dbname.backuplist.$DATE_SUFFIX" >> ${db2hist_cmd}

echo "
db2 list history archive log all for $dbname > ${mount}1/backup/${dbname}/$dbname.archivelist.$DATE_SUFFIX" >> ${db2hist_cmd}
