...
function show_usage {
echo "usage: backup-db2-coh-nfs-mount.bash -d <database name> -t <full or incremental> -l <offline or online> -y <Cohesity-cluster> -v <view> -m <mount-prefix> -n <number of mounts> -p <number of sessions> -e <retention> -w <yes/no>"
echo " "
