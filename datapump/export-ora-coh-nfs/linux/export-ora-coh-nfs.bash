...
echo " -s : sqlplus connection (example: \"<dbuser>/<dbpass>@<database connection string>\",  Database will exported to the host where this database is)"
...
dbname=`grep "\-" $stdout -A1 | grep DB | awk '{print $1}'`
#dbname=`grep -i string $stdout | awk '{print $3}'`
